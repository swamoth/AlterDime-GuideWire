...
```bash
node "C:/Users/swaga/Downloads/ppt/AlterDime-GuideWire/.opencode/get-shit-done/bin/gsd-tools.cjs" commit "docs: plant seed — {$IDEA}" --files .planning/seeds/SEED-{PADDED}-{slug}.md
```
</step>
