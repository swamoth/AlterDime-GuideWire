...
5. Commit:
   ```bash
   node "C:/Users/swaga/Downloads/ppt/AlterDime-GuideWire/.opencode/get-shit-done/bin/gsd-tools.cjs" commit "docs: create thread — ${ARGUMENTS}" --files ".planning/threads/${SLUG}.md"
   ```
