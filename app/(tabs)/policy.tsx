...
import { CircleCheck, ArrowUpCircle, ArrowDownCircle, RefreshCw, XCircle } from 'lucide-react-native';
    ...
    <Animated.ScrollView entering={FadeIn.duration(400)} style={styles.container} contentContainerStyle={styles.content}>
        ...
        <View style={styles.coverageBox}>
          ...
          {activePlan.coverage.map((c, i) => (
            <View key={i} style={{ flexDirection: 'row', alignItems: 'center', gap: 8, marginBottom: 4 }}>
              <CircleCheck size={14} color={Colors.dark.lime} />
              <Text style={styles.coverageItem}>{c}</Text>
            </View>
          ))}
        </View>
      ...
      <View style={styles.actionsGrid}>
        <TouchableOpacity style={styles.actionBtn}>
          <ArrowUpCircle size={22} color={Colors.dark.lime} style={{ marginBottom: 6 }} />
          <Text style={styles.actionLabel}>Upgrade Plan</Text>
        </TouchableOpacity>
        <TouchableOpacity style={styles.actionBtn}>
          <ArrowDownCircle size={22} color={Colors.dark.textSecondary} style={{ marginBottom: 6 }} />
          <Text style={styles.actionLabel}>Downgrade</Text>
        </TouchableOpacity>
        <TouchableOpacity style={styles.actionBtn}>
          <RefreshCw size={22} color={Colors.dark.textSecondary} style={{ marginBottom: 6 }} />
          <Text style={styles.actionLabel}>Renew Manually</Text>
        </TouchableOpacity>
        <TouchableOpacity style={[styles.actionBtn, styles.actionBtnDanger]}>
          <XCircle size={22} color={Colors.dark.red} style={{ marginBottom: 6 }} />
