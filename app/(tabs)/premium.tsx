    ...
    <ScrollView style={styles.container} contentContainerStyle={styles.content}>
      ...
      {result && (
        <View style={styles.resultCard}>
          ...
          <Text style={styles.resultPrice}>₹{result.finalPremium}</Text>
...
const styles = StyleSheet.create({
  ...
  planIcon: { fontSize: 24, marginBottom: 6 },
  ...
  modelIcon: { fontSize: 20, marginRight: 12 },
